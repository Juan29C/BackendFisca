...
class CoactivoResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'total_a_cobrar' => bcadd(bcadd($this->monto_deuda, $this->monto_costas, 2), $this->monto_gastos_admin, 2),
            'saldo_pendiente' => bcsub(bcadd(bcadd($this->monto_deuda, $this->monto_costas, 2), $this->monto_gastos_admin, 2), $this->monto_pagado, 2),
            'estado' => $this->estado,
